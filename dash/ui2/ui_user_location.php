...
<script>
    ...
    function user_click(arr)
    {
        ...
        document.getElementById("selected-user").innerHTML = "Pilih akses lokasi untuk user " + data[1];
        ...
        send(svr_intf + '/intf_get_user.php', inp,
            function (inp) {
                if (inp.err == 0) {
                    ...
                    create_table("tabel-user", inp.user, "user_click" , "", "100%;", "");
                }
            }
        );
    }
    ...
    function on_load_event() {
        ...
        // chapter
        c = add_child(p.id, "tabel-user", "div");
        c.className = "chapter";
