...
<script>
    ...
    function refresh_data() {
        inp = new Object();
        inp.token = "get_data_anualy";
        inp.lokasi = get_checkbox_value('list-lokasi');
        send(svr_intf + '/intf_get_data_anualy.php', inp, show_data);
    ...
    function show_data(inp) {
        ...
        for (i = 0; i < lokasi.length; i++) 
        {
            ...
            let title = "Pendapatan Tahunan " + lokasi[i].info[0][1];
    ...
    function on_load_event() {
        // title
        document.getElementById('page-title').innerHTML = "Pendapatan Tahunan";
            ...
            function()
                {
                    ...
                    for(let i=0; i<data_pdf.length; i++)
                        ...
                        // Simpan file PDF
                        pdf.save("data_tahunan_" + p.site + ".pdf");
                        }
                }
            );
        };
            ...
            function()
                {
                    ...
                    for(let i=0; i<data_pdf.length; i++)
                        ...
                        if (p.table1 != null) {
                            ...
                            .convert(p.table1,
                                {
                                name: "data_tahunan_" + p.site + ".xlsx",
                                sheet: {
                                    name: "Sheet 1" 
                                    }
                                });
