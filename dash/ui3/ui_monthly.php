...
<script>
    ...
    function refresh_data() {
        inp = new Object();
        inp.token = "get_data_monthly";
        inp.lokasi = get_checkbox_value('list-lokasi');
        inp.tahun = get_combobox_value('i-tahun');
        send(svr_intf + '/intf_get_data_monthly.php', inp, show_data);
    ...
    function show_data(inp) {
        ...
        for (i = 0; i < lokasi.length; i++) 
        {
            ...
            let title = "Pendapatan Bulanan Tahun " + get_combobox_value('i-tahun') + " " + lokasi[i].info[0][1];
    ...
    function on_load_event() {
        // title
        document.getElementById('page-title').innerHTML = "Pendapatan Bulanan";
            ...
            function()
                {
                    ...
                    for(let i=0; i<data_pdf.length; i++)
                        ...
                        // Simpan file PDF
                        pdf.save("data_bulanan_" + p.site + ".pdf");
                        }
                }
            );
        };
            ...
            function()
                {
                    ...
                    for(let i=0; i<data_pdf.length; i++)
                        ...
                        if (p.table1 != null) {
                            ...
                            .convert(p.table1,
                                {
                                name: "data_bulanan_" + p.site + ".xlsx",
                                sheet: {
                                    name: "Sheet 1" 
                                    }
                                });
