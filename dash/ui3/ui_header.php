...
<head>
    ...
    <script src="<?php echo constant('svr_lib');?>/Chart.js"></script>
    <script src="<?php echo constant('svr_lib');?>/jspdf.min.js"></script>
    <script src="<?php echo constant('svr_lib');?>/tableToExcel.js"></script>
...
<body>
    ...
    <div id = "modal-container">
        ...
        <div id="id-ganti-password" class="modal">
            <div id="" class="form" style="width: 250px;">
                <div class="form-header">
                    <span class="font-l bold">Ganti Password</span>
                    <span class="icon-key"></span>
                </div>
                <div class="form-content">
                    <span class="font-m">Password Lama</span>
                    <input id="i_pass_lama" type="password"></input>
                    <span class="font-m">Password Baru</span>
                    <input id="i_pass_baru" type="password"></input>
                    <span class="font-m">Ulangi Password Baru</span>
                    <input id="i_pass_baru_2" type="password"></input>
                </div>
                <div class="form-footer">
                    <button class="font-s" onclick="next_ganti_password();"><span class="icon-checkmark1"></span>OK</button>
                    <button class="font-s" onclick="close_modal()"><span class="icon-cancel"></span>Cancel</button>
                </div>
            </div>
        </div>
        ...
        <div id="id-message" class="modal">
            <div id="" class="form" style="width: 250px;">
                ...
                <div class="form-content">
                    <span class="font-l" id="text-message">User ID</span>
                </div>
                <div class="form-footer">
                    <button class="font-s" id="message-ok"><span style="color:lime;" class="icon-checkmark1"></span>OK</button>
                    <button class="font-s" id="message-cancel" onclick="close_modal()"><span style = "color:red" class="icon-cancel"></span>Cancel</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="menu-bar">
        ...
        <div style="flex: 1;display: flex; align-items: center; justify-content: center;">
            <span id = "page-title" class="font-l bold"></span>
        </div>
        <div>
            <?php 
            if(is_logged())
        ...
        <div class="menu-icon" style="margin-left:20px;">
            <span class="icon-home" id="" onclick="window.open('<?php echo constant('svr_ui');?>/ui_main.php','_self')"></span>
        </div>
    </div>
                ...
                echo '<div class="menu"">
                    ...
                    <div style="height: var(--menu-height);">
                        <div class="sub-menu-container">
                            <!--sub menu 1-->
                            <div class="sub-menu">
                                <button onclick="window.open(\''.constant("svr_ui").'/ui_daily.php\',\'_self\')"><span class="icon-calendar"></span>Harian</button>
                            </div>
                            <!--sub menu 2-->
                            <div class="sub-menu">
                                <button onclick="window.open(\''.constant("svr_ui").'/ui_monthly.php\',\'_self\')"><span class="icon-calendar"></span>Bulanan</button>
                            </div>
                            <!--sub menu 3-->
                            <div class="sub-menu">
                                <button onclick="window.open(\''.constant("svr_ui").'/ui_annualy.php\',\'_self\')"><span class="icon-calendar"></span>Tahunan</button>
                            </div>
                        </div>
                    </div>
                </div>';
                    ...
                    echo '<div class="menu">
                        ...
                        <div style="height: var(--menu-height);">
                            <div class="sub-menu-container">
                                <!--sub menu 1-->
                                <div class="sub-menu">
                                    <button onclick="window.open(\''.constant("svr_ui").'/ui_user.php\',\'_self\')"><span class="icon-users"></span>Daftar User</button>
                                </div>
                                <!--sub menu 2-->
                                <div class="sub-menu">
                                    <button onclick="window.open(\''.constant("svr_ui").'/ui_user_location.php\',\'_self\')"><span class="icon-location"></span>Lokasi
                                        User</button>
                                </div>
                            </div>
                        </div>
                    ...
                    if(is_logged())
                        {
                            ...
                            <div class="sub-menu">
                                <button onclick="do_ganti_password()"><span class="icon-key"></span>Ganti Password</button>
                            </div>';
                        }
                    else
                        {
